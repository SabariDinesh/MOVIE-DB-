...
class MainViewController: UIViewController{
    ...
    func addSpecifications(){
        ...
        appTitle.text = "appTitle".localized()
...
extension MainViewController: UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let navigationVc = UINavigationController(rootViewController: MovieDetailViewController)
            ...
            if thisMovie?.backdrop_path != nil{
                ...
                DispatchQueue.main.async {
                    if thisMovie?.poster_path != nil{
                        MovieDetailViewController.downloadImage(imageLink: (thisMovie?.poster_path!)!)
                    }
                }
            }
        ...
        MovieDetailViewController.label.text = "\(title.uppercased()) \n \n \(description)"
